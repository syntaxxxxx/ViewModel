package com.syntax.android.creaturemon.view.allcreatures

import android.support.v7.widget.RecyclerView
import android.view.View
import android.view.ViewGroup
import com.syntax.android.creaturemon.R
import com.syntax.android.creaturemon.app.inflate
...
class CreatureAdapter(private val creatures: MutableList<Creature>)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(creature: Creature) {
            ...
            itemView.avatarListItem.setImageDrawable(itemView.context.resources.getDrawable(creature.drawable))
